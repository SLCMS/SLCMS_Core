<cfcomponent output="yes" extends="Controller"
	displayname="SL Wiki Module Persistent Functions" 
...
<!--- Contains:
			...
			lots more related stuff :-)
			 --->
<!---  --->
<!---   cloned: 25th Dec 2012 by Kym K, mbcomms from empty module --->
<!--- modified: 25th Dec 2012 -  1st Jan 2012 by Kym K, mbcomms: initial work on it --->
--->
