...
<p class="#attributes.class_LoggedInMsg#"><a href="#application.SLCMS.Paths_Admin.AdminBaseURL#Admin-Home" target="_blank">Go to Administration Area (in new tab/window)</a></p>
</cfif>
